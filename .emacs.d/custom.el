(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nix-mode lua-mode restclient wrap-region avy wgrep counsel ivy-hydra dired-subtree origami move-text markdown-mode flx smex php-mode zygospore org-pomodoro yasnippet solarized-theme noflet multiple-cursors magit haskell-mode flycheck expand-region)))
