(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (centered-window elfeed undo-tree ghc string-inflection company-coq monochrome-theme htmlize phi-search yasnippet flycheck-flow flow-minor-mode company counsel-projectile web-mode auctex fiplr org-plus-contrib whitespace-cleanup-mode wrap-region exec-path-from-shell nix-mode lua-mode restclient avy wgrep counsel move-text markdown-mode flx smex noflet multiple-cursors magit haskell-mode flycheck expand-region)))
