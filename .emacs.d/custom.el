(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (real-auto-save magit org-plus-contrib centered-window undo-tree ghc string-inflection company-coq monochrome-theme htmlize yasnippet flycheck-flow flow-minor-mode company counsel-projectile web-mode auctex fiplr whitespace-cleanup-mode wrap-region exec-path-from-shell nix-mode lua-mode restclient avy wgrep counsel move-text markdown-mode flx smex noflet multiple-cursors haskell-mode flycheck expand-region)))
