...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "7", function () awful.util.spawn("escrotum -sC") end),
    awful.key({ modkey }, "8", function () awful.util.spawn("escrotum -s ~/screenshots/%Y-%m-%d-%H%M%S_$wx$h.png") end)
)
